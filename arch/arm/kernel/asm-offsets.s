...
@ options passed:  -nostdinc -I /home/demo/Vidéos/wave_sd/arch/arm/include
...
@ -iprefix /home/demo/Vidéos/wave_sd/toolchain/bin/../lib/gcc/arm-linux-gnueabihf/4.7.3/
@ -isysroot /home/demo/Vidéos/wave_sd/toolchain/bin/../arm-linux-gnueabihf/libc
@ -D __KERNEL__ -D __LINUX_ARM_ARCH__=7 -U arm -D CC_HAVE_ASM_GOTO
@ -D KBUILD_STR(s)=#s -D KBUILD_BASENAME=KBUILD_STR(asm_offsets)
@ -D KBUILD_MODNAME=KBUILD_STR(asm_offsets)
@ -isystem /home/demo/Vidéos/wave_sd/toolchain/bin/../lib/gcc/arm-linux-gnueabihf/4.7.3/include
@ -include include/generated/autoconf.h
@ -MD arch/arm/kernel/.asm-offsets.s.d arch/arm/kernel/asm-offsets.c
@ -mlittle-endian -mno-unaligned-access -marm -mabi=aapcs-linux
...
@ -marm -mglibc -mlittle-endian -msched-prolog -mvectorize-with-neon-quad
